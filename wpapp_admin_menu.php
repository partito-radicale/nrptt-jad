...
function paypal_payment_options_page() {
    ...
    $paypal_payment_platform = stripslashes(get_option('paypal_payment_platform'));
        ...
        <form method="post" action="">
            ...
            <div class="inside">
                ...
                <table class="form-table">
                    ...
                    <tr valign="top"><td width="25%" align="left">
                            <strong>NRPTT Paypal Email address:</strong>
                        </td><td align="left">
                            <input name="nrptt_pp_payment_email" 
                                   type="text" size="35" value="<?php echo esc_attr(get_option('nrptt_pp_payment_email')); ?>"/>
                            <br /><i>This is the Paypal Email address where the payments will go</i><br />
                        </td></tr>

                    <tr valign="top"><td width="25%" align="left">
                            <strong>Paypal Platform: </strong>
                        </td><td align="left">
                            <select id="paypal_payment_platform" name="paypal_payment_platform">
                            <?php _e('<option value="TEST"') ?><?php if ($paypal_payment_platform == "TEST") echo " selected " ?><?php _e('>Sandbox</option>') ?>
                            <?php _e('<option value="PROD"') ?><?php if ($paypal_payment_platform == "PROD") echo " selected " ?><?php _e('>Production</option>') ?>
                            </select>
                            <br /><i>Working platform for paypal (Test/Production).</i><br />
                        </td>
                     </tr>
