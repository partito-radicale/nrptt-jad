...
function wpapp_validate_paypl_ipn() {
    ...
    if (!$wpapp_ipn_validated) {
        ...
        $admin_email = get_bloginfo('admin_email');
        $subject = 'IPN validation OK for a payment';
        $body = "This is a notification email from the WP Accept PayPal Payment plugin letting you know that a payment verification gone ok." .
        "\n\nPlease check your paypal account to make sure you received the correct amount in your account before proceeding" .
        wp_mail($admin_email, $subject, $body);
        exit;
    }
